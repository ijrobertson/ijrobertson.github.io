...
//
// Problem: on mobile (backgrounding the browser, locking the screen, switching
// wifi ↔ cellular), the WebChannel connection Firestore's SDK uses for
// onSnapshot listeners and in-flight writes can go stale without the SDK
...
// chat message can look stuck/frozen until the user manually leaves and
// reopens the conversation, which happens to force a fresh listener.
//
